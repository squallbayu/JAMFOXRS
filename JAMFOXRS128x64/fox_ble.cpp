...
class MyServerCallbacks: public BLEServerCallbacks {
    void onConnect(BLEServer* pServer) override {
        ...
        // =============================================
        // PERBAIKAN: Saat connected, tampilkan Page 1 (Jam)
        // =============================================
        if (displayReady) {
            appModeDisplayed = false;
            currentPage = 1;
            transitionFromAppModeToClock();
            serialPrintfln("[BLE] Switched to Clock Page (Page 1)");
        }
    }
    ...
    void onDisconnect(BLEServer* pServer) override {
        ...
        // =============================================
        // PERBAIKAN: Saat disconnected, tampilkan "APP MODE waiting..."
        // =============================================
        if (bleActive && displayReady) {
            waitingForConnection = true;
            appModeDisplayed = true;
            showAppModeDisplay();  // Tampilkan "APP MODE waiting..."
        }
    }
};
...
void activateBLE() {
    ...
    pCharacteristic->setValue("Votol_BLE Ready");
    ...
    // =============================================
    // PERBAIKAN: Tampilkan "APP MODE waiting..."
    // =============================================
...
bool isInAppMode() {
    // TRUE jika BLE aktif, apapun status koneksi
    // Digunakan untuk menampilkan "BLE ON" di Page 1
    return bleActive;
}
