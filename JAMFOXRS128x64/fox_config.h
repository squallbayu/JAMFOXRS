...
// =============================================
// DISPLAY CONFIGURATION - 0.96 INCH
// =============================================
#define DISPLAY_TYPE_SSD1306    1
#define DISPLAY_TYPE_SH1106     2

// Pilih tipe display: SSD1306 atau SH1106
#define DISPLAY_TYPE DISPLAY_TYPE_SSD1306  // Ganti ke SH1106 jika perlu

// I2C Clock Speed (Hz)
#define I2C_CLOCK_SPEED 100000  // 100kHz (coba 400000 jika masih lambat)

// Display begin parameter
// SSD1306: (SSD1306_SWITCHCAPVCC, address)
// SH1106: (SSD1306_SWITCHCAPVCC, address, false)
#define DISPLAY_BEGIN_RESET false  // false untuk SH1106, true untuk SSD1306

// Disable font besar saat inisialisasi (untuk test)
#define DISABLE_LARGE_FONTS_INIT false  // Set true untuk test
...
#define DISPLAY_TASK_STACK_SIZE 8192           // Stack untuk display task
...
// =============================================
// PAGE 1 - CLOCK & MODE CONFIGURATION
// =============================================
// Mode Text
#define PAGE1_MODE_FONT &FreeSansBold12pt7b
#define PAGE1_MODE_X 0
#define PAGE1_MODE_Y 22

// Clock Time
#define PAGE1_TIME_FONT &FreeSansBold18pt7b
#define PAGE1_TIME_X 0
#define PAGE1_TIME_Y 58

// Clock Date
#define PAGE1_DAY_X CLOCK_DAY_POS_X
#define PAGE1_DAY_Y (CLOCK_DAY_POS_Y + 28)
#define PAGE1_DATE_X CLOCK_DATE_POS_X
#define PAGE1_DATE_Y (CLOCK_DATE_POS_Y + 28)
#define PAGE1_YEAR_X CLOCK_YEAR_POS_X
#define PAGE1_YEAR_Y (CLOCK_YEAR_POS_Y + 28)

// BLE ON text
#define PAGE1_BLE_ON_TEXT "BLE ON"
#define PAGE1_BLE_ON_FONT &FreeSansBold12pt7b
#define PAGE1_BLE_ON_X 0
#define PAGE1_BLE_ON_Y 22

// =============================================
// PAGE 2 - TEMPERATURE CONFIGURATION
// =============================================
// Fonts
#define PAGE2_LABEL_FONT &FreeSansBold9pt7b
#define PAGE2_VALUE_FONT &FreeSansBold9pt7b
#define PAGE2_DEGREE_FONT NULL   // NULL = default font

// Positions
#define PAGE2_ROW1_Y 16
#define PAGE2_ROW2_Y 34
#define PAGE2_ROW3_Y 52
#define PAGE2_LABEL_X 4
#define PAGE2_VALUE_PADDING 16
#define PAGE2_DEGREE_OFFSET_X 1
#define PAGE2_DEGREE_OFFSET_Y -15

// Labels
#define PAGE2_LABEL1 "ECU"
#define PAGE2_LABEL2 "BLDC"
#define PAGE2_LABEL3 "BATT"

// Degree symbol
#define PAGE2_DEGREE_SYMBOL "o"

// =============================================
// PAGE 3 - VOLTAGE & CURRENT CONFIGURATION
// =============================================
// Fonts
#define PAGE3_VOLTAGE_FONT &FreeSansBold18pt7b
#define PAGE3_CURRENT_FONT &FreeSansBold18pt7b
#define PAGE3_UNIT_FONT &FreeSansBold9pt7b

// Positions
#define PAGE3_VOLTAGE_Y 28
#define PAGE3_CURRENT_Y 58
#define PAGE3_UNIT_OFFSET_X 4

// Units
#define PAGE3_VOLTAGE_UNIT "V"
#define PAGE3_CURRENT_UNIT "A"

// Data Fresh Indicator
#define PAGE3_FRESH_X 120
#define PAGE3_FRESH_Y 0
#define PAGE3_FRESH_SYMBOL "x"

// =============================================
// PAGE 4 - POWER CONFIGURATION
// =============================================
// Fonts
#define PAGE4_TOP_FONT &FreeSansBold9pt7b
#define PAGE4_POWER_FONT &FreeSansBold18pt7b
#define PAGE4_WATT_FONT &FreeSansBold9pt7b

// Positions
#define PAGE4_TOP_Y 12
#define PAGE4_POWER_Y 42
#define PAGE4_WATT_Y 60

// Text
#define PAGE4_WATT_TEXT "watt"

// =============================================
// APP MODE DISPLAY CONFIGURATION
// =============================================
#define APP_MODE_FONT &FreeSansBold9pt7b
#define APP_MODE_X (SCREEN_WIDTH - (7 * 10)) / 2
#define APP_MODE_Y 20
#define APP_MODE_STATUS_Y 55

#define APP_MODE_WAITING_TEXT "waiting..."
#define APP_MODE_CONNECTED_TEXT "connected"

// BLE OFF Display
#define BLE_OFF_FONT &FreeSansBold9pt7b
#define BLE_OFF_X (SCREEN_WIDTH - (6 * 10)) / 2
#define BLE_OFF_Y 20
#define BLE_OFF_STATUS_Y 35
#define BLE_OFF_TEXT "BLE OFF"
#define BLE_OFF_STATUS_TEXT "Disconnected"
